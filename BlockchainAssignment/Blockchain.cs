...
namespace BlockchainAssignment
{
    ...
    class Blockchain
    {
        ...
        // Task 3 stores current mining preference
        ...
        // Task 2 Dynamic difficulty settings
        public double TargetBlockTimeSeconds { get; set; } = 15.0;  // Target time in seconds between blocks
        public double CurrentDifficulty { get; private set; } = 4.0; // Starting difficulty
        
        // For adjustment smoothing (avoid wild swings)
        private int difficultyAdjustmentBlocks = 3;   // How many blocks to average for adjustment
        private double maxAdjustmentFactor = 0.25;    // Maximum adjustment per block (25%)
        ...
        /* Added for Task 2 - Calculate new difficulty based on recent mining times */
        public double CalculateNewDifficulty()
        {
            ...
            // Get the number of blocks to analyze (up to difficultyAdjustmentBlocks)
            ...
            // If mining is too slow, decrease difficulty; if too fast, increase it
        ...
        // Enhanced for Task 3 - Added support for different transaction selection methods
        ...
        public Tuple<List<Transaction>, string> GetPendingTransactionsWithDetails(string minerAddress = "")
        {
            ...
            switch (CurrentPreference)
            {
                ...
                case MiningPreference.Altruistic:
                    // Sort by timestamp (oldest first) - this is more accurate than assuming pool order
                ...
                case MiningPreference.SelfAddress:
                    ...
                    {
                        // Check if any transactions involve miner's address
                        ...
                        if (hasRelatedTx)
                        {
                            // Prioritize transactions involving miner's address
            ...
            // Performance optimization: only take what we need instead of sorting entire pool
        ...
        //  (Part 4) Helper to grab the most recently added block in the chain
